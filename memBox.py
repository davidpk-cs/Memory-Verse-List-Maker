...
if __name__ == "__main__":
    ...
    def verseAdd():
        ...
        fullPageDisplay.delete(0, tk.END)
        ...
        for id in userVerseList:
            if(isinstance(id, int)):
                ...
                if(len(str(id)) == 7):
                    stringID = "0" + str(id)
                fullPageDisplay.insert(tk.END, get_bible_book(int(stringID[0:2])) + " " + str(int(stringID[2: 5])) + ":" + str(int(stringID[5:])) + " - " + bible.get_verse_text(id) + "\n\n")
            else:
                stringID = str(id[0])
                finalID = str(id[-1])
                ...
                toDisplayInFull += "\n\n"
                fullPageDisplay.insert(tk.END, toDisplayInFull)
    ...
    fullDisplay.grid_columnconfigure(0, weight = 2)  
    ...
    fullPageDisplay = tk.Listbox(fullDisplay)
    ...
    fullPageDisplay.grid(row = 0, column = 0, sticky = "nsew")
